...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
    {
        if (!userManager.Users.Any())
        {
            ...
            {
                new User{DisplayName="Eki", UserName="eki@gmail.com", Email="eki@gmail.com"},
                new User{DisplayName="Lela", UserName="lela@gmail.com", Email="lela@gmail.com"},
                new User{DisplayName="Loni", UserName="loni@gmail.com", Email="loni@gmail.com"}
            };
